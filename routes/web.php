...
Route::middleware(['auth'])->group(function () {
    Route::prefix('/shopping_list')->group(function () {
        ...
        Route::delete('/delete/{item_id}', [ShoppingListController::class, 'delete'])->whereNumber('item_id')->name('delete');
        Route::post('/complete/{item_id}', [ShoppingListController::class, 'complete'])->whereNumber('item_id')->name('complete');
    });
    //     // // 購入済み「買うもの」一覧
